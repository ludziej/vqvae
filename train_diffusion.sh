...
python3 run_training.py --gpus=[0,1] --config=config_big --model=diffusion --train_path=resources/fma_wav --compressor=big_vae \
	...
	--diffusion.main_dir=generated/models/big_diffusion/fma_after_cls/ --diffusion.restore_ckpt=last.ckpt \
	--diffusion.opt_params.lr=0.00005 --diffusion.opt_params.lr_warmup=1 --diffusion.prep_level=1 \
