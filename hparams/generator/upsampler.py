...
small_upsampler_params = default_upsampler_params.update(**small_transformer_params.update(
...
big_upsampler_params = default_upsampler_params.update(**big_transformer_params.update(
